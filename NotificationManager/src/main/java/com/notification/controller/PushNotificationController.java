...
public class PushNotificationController 
{
	...
	public ModelAndView sendNotification(@ModelAttribute("notification") PushNotificationTracker notification,@RequestParam("image") MultipartFile image)
	{
	...
	public ModelAndView addNotification(@ModelAttribute("notification") PushNotificationTracker notification,@RequestParam("image") MultipartFile image)
	{
